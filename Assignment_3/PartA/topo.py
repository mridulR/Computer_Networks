...
class QuaggaTopo(Topo):
    ...
    def __init__(self):
        ...
        quaggaHosts = []
        quaggaHosts.append(QuaggaHost(name='H1', ip='172.0.0.1/20',
                                      loIP='10.0.1.1/24'))
        quaggaHosts.append(QuaggaHost(name='R1', ip='172.0.0.2/20',
                                      loIP='10.0.2.1/24'))
        quaggaHosts.append(QuaggaHost(name='R2', ip='173.0.0.1/20',
                                      loIP='10.0.3.1/24'))
        quaggaHosts.append(QuaggaHost(name='R3', ip='174.0.0.1/20',
                                      loIP='10.0.3.1/24'))
        quaggaHosts.append(QuaggaHost(name='R4', ip='177.0.0.2/20',
                                      loIP='10.0.4.1/24'))
        quaggaHosts.append(QuaggaHost(name='H2', ip='177.0.0.1/20',
                                      loIP=None))
        ...
        for host in quaggaHosts:
            ...
            quagga_list.append(self.addHost(name=host.name,
                                           ip=host.ip,
                                           hostname=host.name,
                                           privateLogDir=True,
                                           privateRunDir=True,
	...
	self.addLink(quagga_list[0], quagga_list[1])	
	self.addLink(quagga_list[1], quagga_list[2])
	self.addLink(quagga_list[1], quagga_list[3])
	self.addLink(quagga_list[5], quagga_list[4])
	self.addLink(quagga_list[2], quagga_list[4])
	self.addLink(quagga_list[3], quagga_list[4])
